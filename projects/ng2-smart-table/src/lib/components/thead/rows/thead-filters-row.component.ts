...
export class TheadFitlersRowComponent<T extends object> implements OnChanges {
  ...
  getVisibleColumns(columns: Array<Column<T, unknown, keyof T>>): Array<Column<T, unknown, keyof T>> {
